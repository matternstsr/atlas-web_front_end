...
![Bootstrap Logo](README_images/boot1.png)

Bootstrap is a free and open-source CSS framework aimed at responsive, mobile-first front-end web development. It provides CSS and JavaScript design templates for various interface components like typography, forms, buttons, navigation, and more.

## Resources

- [Bootstrap Documentation](https://intranet.atlasschool.com/rltoken/7MBV_iWLTpfrZS_VqqQ6UQ)

## Learning Objectives

By the end of this project, you should be able to:

- Explain the usage of Containers
- Understand the Grid system
- Utilize Components effectively
- Employ Utilities for styling
...
- Utilize the CDN version and add the appropriate `<link>` in the `<head>` part of your HTML.
...
From the provided HTML, add Bootstrap to reset the CSS styling.
...
![Result](README_images/boot2.jpg)
...
Build a responsive web page using Bootstrap classes only, without defining any custom styling.
 ...
 ![Result](README_images/boot3.gif)   
...
Build a responsive web page using Bootstrap classes only, following the provided specifications.
...
![Result](README_images/boot4.png)
![Result](README_images/boot5.gif)
...
Build a responsive web page using Bootstrap classes only, adhering to the given requirements.
...
![Result](README_images/boot6.png)
![Result](README_images/boot7.png)
![Result](README_images/boot8.gif)
...
Create a responsive web page using Bootstrap classes only, maintaining the specified behaviors and styles.
...
![Result](README_images/boot9.png)
![Result](README_images/boot10.png)
![Result](README_images/boot11.png)
![Result](README_images/boot12.gif)      
...
Develop a responsive web page with Bootstrap classes only, as per the provided guidelines.
...
![Result](README_images/boot13.gif)
...
Create a custom stylesheet `6-styles.css` to match the specified layout while adhering to Bootstrap's structure.
...
![Result](README_images/boot13.png)
![Result](README_images/boot14.png)
![Result](README_images/boot15.png)
![Result](README_images/boot16.gif)
